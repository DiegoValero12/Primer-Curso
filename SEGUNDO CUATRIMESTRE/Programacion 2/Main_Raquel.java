...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println("Distancia entre 0,0 y 0,0: "+coordenada.distancia(new Coordenada(0,0)));//cuando sera -1??
		...
		String fresa="fresa";
		double valor2=0.035;
		System.out.println("Añadido "+Valores.add(cadena,valor));
		System.out.println("Añadido "+Valores.add(fresa,valor2));
		System.out.println("Añadido "+Valores.add("naranja",0));
		...
		Fruto fruto3=new Fruto("platano");//como ya hay una pitaya no se anyade?
		...
		for(int i=0;i<recolectado2.size();i++) {		//deberia salir pitaya o nuez??? dentro de fruto tiene nombre pitaya porque no esta en valores pero en planta tiene nuez
			System.out.println("	Posicion "+i+": "+recolectado2.get(i).getNombre()+" "+recolectado2.get(i).getPeso()+" "+recolectado2.get(i).getEstado());
		}
		//no salen ordenados porque son dos arrays distintos que se juntan
		...
		/*huerto3.setCuidador(miguel);//se debe añadir tambien en el cuidador??
		if(miguel.getHuerta()!=null)
			System.out.println("Coordenadas Miguel: "+miguel.getHuerta().getLocalizacion());//coincide con huerto3
		*/
